...
export const ScheduleItemWithDescription: FC<ScheduleItemInternalProps> = ({
  ...
  return (
    <button
      ...
      className={clsx(
        'grid items-center overflow-hidden rounded-lg bg-primary text-left font-medium uppercase leading-[1.05] text-black transition duration-100 ease-out',
        'hover:bg-secondary-dark hover:fill-black',
        { 'bg-secondary-dark fill-black': openDescription }
      )}
    >
      <div className='flex items-center border-black'>
        <div className='grid px-2 py-1 lg:px-3 lg:py-1.5'>
          <div className='flex'>{artist?.title}</div>
          <div
            className={clsx(
              'grid gap-1.5 pt-0.5 text-[12px] font-medium normal-case lg:pt-1.5 lg:text-[13px] 2xl:text-[15px]',
              {
